...
export default function SideNav() {
  ...
  return (
    <aside className="hidden lg:flex flex-col bg-[#f8f9ff] border-r border-[#c6c6cd] w-64 h-full p-4 gap-2 shrink-0">
      {/* Org header */}
      <div className="flex items-center gap-3 mb-4 p-2">
        ...
        <div className="overflow-hidden">
          <div className="text-sm font-semibold text-black truncate">Intelligence Unit</div>
          <div className="text-xs text-[#45464d] truncate">Strategic Analysis</div>
        </div>
      </div>
      ...
      <Link
        href="/investigate"
        className="w-full bg-black text-white text-xs font-medium py-2 px-4 rounded-lg flex items-center justify-center gap-2 mb-4 hover:opacity-90 transition-opacity"
      >
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-xs font-medium transition-all ${
                isActive
                  ? "bg-[#dce9ff] text-black font-semibold"
                  : "text-[#45464d] hover:bg-[#eff4ff] hover:text-black"
              }`}
            >
              <span className={isActive ? "text-black" : "text-[#45464d]"}>{item.icon}</span>
              {item.label}
            </Link>
          );
        })}
      ...
      {/* Settings */}
      <div className="mt-auto border-t border-[#c6c6cd] pt-3">
        <Link
          href="/settings"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-xs font-medium text-[#45464d] hover:bg-[#eff4ff] hover:text-black transition-all"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
