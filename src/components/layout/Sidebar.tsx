    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-b border-[#E5E7EB] flex flex-col space-y-3">
          <Link href="/dashboard" className="flex flex-col group" onClick={onClose}>
      ...
      <aside className="hidden md:w-[250px] bg-white/75 backdrop-blur-md border-r border-[#E5E7EB] flex flex-col shrink-0 h-screen sticky top-0 z-30 select-none shadow-sm">
        {/* Brand Header */}
        <div className="p-4 border-b border-[#E5E7EB] flex flex-col space-y-3">
